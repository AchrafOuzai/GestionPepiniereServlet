...
<body>
 <div class="sidebar">
	...
	<br>
		...
		<div class="container">
    <div>
        <a href="<%=request.getContextPath()%>/produit/formNouveau" class="btn btn-success">Ajouter un produit</a>
    </div>
    <br>
    
    <form action="<%=request.getContextPath()%>/produit/rechercher" method="get">
    ...
    <tr>
        ...
        <td>
            <!-- Modifier Button -->
            <a class="btn btn-info" href="<%=request.getContextPath()%>/produit/formModifier?id_produit=${produit.id}">
                <i class="fa-solid fa-pen-to-square" style="font-size:20px"></i>
            </a>
            <!-- Supprimer Button -->
            <a class="btn btn-danger" href="<%=request.getContextPath()%>/produit/supprimer?id_produit=${produit.id}">
