	...
	<br>
		...
		<div class="container">
			...
			<div >
				...
				<a href="<%=request.getContextPath()%>/formNouveau" class="btn btn-success">Ajouter un produit</a>
			</div>
			<br>
			...
			<form action="<%=request.getContextPath()%>/rechercher" method="get">
			    ...
			    <div class="input-group" style="display: flex; justify-content: flex-end;" >
			        <input type="text" style="width: 200px;border-width: thin;margin-right:5px;" placeholder="Nom du produit" name="nomProduit">
				...
				<tbody>
					...
					<c:forEach var="produit" items="${listProduits}">
						...
						<td>
							...
							<td><a class="btn btn-info" href="formModifier?id_produit=<c:out value='${produit.id}' />"><i class="fa-solid fa-pen-to-square" style="font-size:20px"></i></a>
								
								<a class="btn btn-danger" href="supprimer?id_produit=<c:out value='${produit.id}' />"><i class="fa-solid fa-trash" style="font-size:20px"></i></a></td>
						</tr>
					</c:forEach>
